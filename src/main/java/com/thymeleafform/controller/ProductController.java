package com.thymeleafform.controller;

import com.thymeleafform.FileUploadUtil;
import com.thymeleafform.model.Product;
import com.thymeleafform.service.ProductService;
...
public class ProductController {
    ...
    public String UploadImage(@PathVariable(value = "id") long id, Model model) {
    ...
    public String findPaginated(@PathVariable(value = "pageNo") int pageNo,
        ...
        model.addAttribute("listProduuct", listProduct);
        return "index";
    }
